...
void Page::getPageHeaderInfo() {
  std::cout << "free_space_lower_bound: " << header_.free_space_lower_bound << std::endl;
  std::cout << "free_space_upper_bound: " << header_.free_space_upper_bound << std::endl;
  std::cout << "num_slots: " << header_.num_slots << std::endl;
  std::cout << "num_free_slots: " << header_.num_free_slots << std::endl;
  std::cout << "current_page_number: " << header_.current_page_number << std::endl;
  std::cout << "next_page_number: " << header_.next_page_number << std::endl;
}
