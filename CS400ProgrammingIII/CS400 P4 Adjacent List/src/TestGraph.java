 ...
 * Edit as you desired and no need to submit as we will use our own test classes.
 */
...
public class TestGraph {
  public static void main(String[] args) {
    ...
    System.out.println("4.Print one of the possible order in which all courses can be taken:");
